...
<section class="container hero">
  <div class="row align-items-center h-100">
    <div class="col-12 col-lg-6">
      <h1>Platform with Focused <br />Discussion</h1>
      <p class="mb-4">Discuss about your code & errors, Upgrade Your Knowledge, and Share Your Insights.</p>
    ...
    <div class="col-12 col-lg-6 h-315px order-first order-lg-last mb-3 mb-lg-0">
      <img class="hero-image float-lg-end" src="{{ url('assets/images/logohome.png') }}" alt="">
    </div>
  </div>
</section>
